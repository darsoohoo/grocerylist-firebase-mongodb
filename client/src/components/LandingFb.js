  ...
  checkboxChange(checkboxValue, itemKey) {
    ...
    this.setState(items =>
      this.setState({ items: this.state.items }, () =>
        console.log('item setstate...', items)
      )
    );
    ...
    return (
      <div className='component-landing'>
        <div className='Aligner flex-container'>
          <div
            id='grocery-table'
            className='mdl-data-table mdl-js-data-table mdl-button--colored'
          >
            <div className='Aligner-item item-input-table'>
              ...
              <table
                ...
                className='table flex mdl-data-table mdl-js-data-table mdl-button--colored'
              >
                <thead>
                  <tr>
                    <th>#</th>
                    ...
                    <tr key={item.key}>
                      ...
                      <td>
                        <Checkbox
                          ...
                          onClick={() =>
                            this.checkboxChange(item.purchased, item.key)
                          }
                        />
                      </td>
                      <td>
